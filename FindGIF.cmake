...
foreach(GIF_LIB ${CONAN_LIBS_GIFLIB})
  find_library(GIF_LIBRARY_${GIF_LIB} NAMES ${GIF_LIB} PATHS ${CONAN_LIB_DIRS_GIFLIB})
  if(NOT GIF_LIBRARY_${GIF_LIB}-NOTFOUND)
    list(APPEND GIF_LIBRARIES ${GIF_LIBRARY_${GIF_LIB}})
    mark_as_advanced(GIF_LIB_${GIF_LIB})
  endif()
endforeach()
...
mark_as_advanced(GIF_LIBRARIES GIT_LIBRARY GIF_INCLUDE_DIR)
